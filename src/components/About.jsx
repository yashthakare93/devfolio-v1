...
import profilePic from '../assets/images/about/yashthakare.jpeg';
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-12 lg:gap-16 items-start">
                ...
                >
                    <div className="group relative">
                        ...
                        <div className="absolute -inset-1 bg-teal-400/10 rounded-lg blur-xl z-0"></div>

                        {/* Image Container */}
                        <div className="relative w-full aspect-square rounded-lg overflow-hidden border-2 border-teal-400/30 shadow-lg">
                            <img
                                src={profilePic} 
                                alt="Yash Thakare"
                                className="w-full h-full object-cover" // No filter needed here
                            />
                            {/* REVERSED: Starts with teal overlay, disappears on hover */}
                            <div className="absolute inset-0 bg-teal-600 opacity-50 group-hover:opacity-0 transition-opacity duration-300 mix-blend-overlay"></div>
                        </div>

                        {/* Hover Border Effect */}
                        <div className="absolute inset-0 border-2 border-teal-400 rounded-lg pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    </div>
                </motion.div>
            </div>
        </motion.section>
